...
import 'package:perf_rse/views/pilotage/controllers/export_data_controller.dart';
...
class ScreenTableauBordPilotage extends StatefulWidget {
  ...
  @override
  State<ScreenTableauBordPilotage> createState() =>
      _ScreenTableauBordPilotageState();
}

class _ScreenTableauBordPilotageState extends State<ScreenTableauBordPilotage> {
  final dropDownController = Get.put(DropDownController());
  final exportDataController = Get.put(ExportDataController());
                  ...
                  Center(
                    child: Card(
                      ...
                      child: Container(
                        ...
                        child: Center(
                            child: Text(
                          tr.governanceSustainableDevelopmentStrategy,
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 25,
                              fontWeight: FontWeight.bold),
